...
class TestTableCompute(unittest.TestCase):
    ...
    def test_z_scores(self):
        ...
        self.assertSequenceEqual(new_table.rows[0], ('a', 2, 3, 4, -0.8660254038))
        self.assertSequenceEqual(new_table.rows[1], (None, 3, 5, None, 0.8660254038))
        self.assertSequenceEqual(new_table.rows[2], ('a', 2, 4, None, -0.8660254038))
        self.assertSequenceEqual(new_table.rows[3], ('b', 3, 4, None, 0.8660254038))

        self.assertSequenceEqual(new_table.columns['z-scores'],(-0.8660254038,0.8660254038,-0.8660254038,0.8660254038))
